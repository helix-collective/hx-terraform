...
export function createInstance(
  ...
  const id: InstanceId = {
    type: 'InstanceId',
    value: '${' + TF.resourceName(resource) + '.id}',
  };
  const arn: AT.Arn = {
    type: 'Arn',
    value: '${' + TF.resourceName(resource) + '.arn}',
  };
  const availability_zone: AT.AvailabilityZone = {
    type: 'AvailabilityZone',
    value: '${' + TF.resourceName(resource) + '.availability_zone}',
  };
...
export function createEip(
  ...
  const public_ip: AT.IpAddress = {
    type: 'IpAddress',
    value: '${' + TF.resourceName(resource) + '.public_ip}',
  };
  const private_ip: AT.IpAddress = {
    type: 'IpAddress',
    value: '${' + TF.resourceName(resource) + '.private_ip}',
  };
...
export function createRouteTableAssociation(
  tfgen: TF.Generator,
  rname: string,
  params: RouteTableAssociationParams
): RouteTableAssociation {
  const fields = fieldsFromRouteTableAssociationParams(params);
  const resource = tfgen.createResource(
    'aws_route_table_association',
    rname,
    fields
  );
  const id: RouteTableAssociationId = {
 ...
 */
export function createRoute53Zone(
  tfgen: TF.Generator,
  rname: string,
  params: Route53ZoneParams
): Route53Zone {
  const fields = fieldsFromRoute53ZoneParams(params);
  const resource = tfgen.createResource('aws_route53_zone', rname, fields);
  const zone_id: AT.HostedZoneId = {
    type: 'HostedZoneId',
    value: '${' + TF.resourceName(resource) + '.zone_id}',
  };
 ...
 */
export function createS3BucketObject(
  tfgen: TF.Generator,
  rname: string,
  params: S3BucketObjectParams
): S3BucketObject {
 ...
 */
export function createIamUserPolicy(
  tfgen: TF.Generator,
  rname: string,
  params: IamUserPolicyParams
): IamUserPolicy {
 ...
 */
export function createIamUserPolicyAttachment(
  tfgen: TF.Generator,
  rname: string,
  params: IamUserPolicyAttachmentParams
...
type IamUserPolicyAttachmentId = {
  type: 'IamUserPolicyAttachmentId';
  value: string;
};
...
export function createEcrRepository(
  ...
  const registry_id: string =
    '${' + TF.resourceName(resource) + '.registry_id}';
  const repository_url: string =
    '${' + TF.resourceName(resource) + '.repository_url}';
...
export function createCloudwatchMetricAlarm(
  tfgen: TF.Generator,
  rname: string,
  params: CloudwatchMetricAlarmParams
  ...
  const id: CloudwatchMetricAlarmId = {
    type: 'CloudwatchMetricAlarmId',
    value: '${' + TF.resourceName(resource) + '.id}',
  };
...
export function createIamRole(
  ...
  const name: string = '${' + TF.resourceName(resource) + '.name}';
  const create_date: string =
    '${' + TF.resourceName(resource) + '.create_date}';
  const unique_id: string = '${' + TF.resourceName(resource) + '.unique_id}';
  const description: string =
    '${' + TF.resourceName(resource) + '.description}';
...
export function createIamInstanceProfile(
  tfgen: TF.Generator,
  rname: string,
  params: IamInstanceProfileParams
): IamInstanceProfile {
  ...
  const id: IamInstanceProfileId = {
    type: 'IamInstanceProfileId',
    value: '${' + TF.resourceName(resource) + '.id}',
  };
  const arn: AT.Arn = {
    type: 'Arn',
 ...
 */
export function createSqsQueuePolicy(
  tfgen: TF.Generator,
  rname: string,
  params: SqsQueuePolicyParams
): SqsQueuePolicy {
 ...
 */
export function createLbTargetGroupAttachment(
  tfgen: TF.Generator,
  rname: string,
  params: LbTargetGroupAttachmentParams
  ...
  const id: LbTargetGroupAttachmentId = {
    type: 'LbTargetGroupAttachmentId',
    value: '${' + TF.resourceName(resource) + '.id}',
  };
 ...
 */
export function createElasticsearchDomain(
  tfgen: TF.Generator,
  rname: string,
  params: ElasticsearchDomainParams
): ElasticsearchDomain {
  ...
  const domain_name: string =
    '${' + TF.resourceName(resource) + '.domain_name}';
 ...
 */
export function createElasticsearchDomainPolicy(
  tfgen: TF.Generator,
  rname: string,
  params: ElasticsearchDomainPolicyParams
...
type ElasticsearchDomainPolicyId = {
  type: 'ElasticsearchDomainPolicyId';
  value: string;
};
...
export function createCloudwatchLogGroup(
  tfgen: TF.Generator,
  rname: string,
  params: CloudwatchLogGroupParams
): CloudwatchLogGroup {
...
export function fieldsFromInstanceRootBlockDeviceParams(
  params: InstanceRootBlockDeviceParams
): TF.ResourceFieldMap {
...
export function fieldsFromInstanceParams(
  params: InstanceParams
): TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
  ...
  TF.addOptionalField(
    ...
    params.associate_public_ip_address,
    TF.booleanValue
  );
  TF.addOptionalField(
    fields,
    'root_block_device',
    params.root_block_device,
    v => TF.mapValue(fieldsFromInstanceRootBlockDeviceParams(v))
  );
  ...
  TF.addOptionalField(
    ...
    TF.listValue(TF.resourceIdValue)
  );
...
export function fieldsFromDbInstanceParams(
  params: DbInstanceParams
): TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
  TF.addField(
  ...
  TF.addOptionalField(
    fields,
    'skip_final_snapshot',
    params.skip_final_snapshot,
    TF.booleanValue
  );
  TF.addOptionalField(
    fields,
    'final_snapshot_identifier',
    params.final_snapshot_identifier,
    TF.stringValue
  );
...
export function fieldsFromVpcParams(params: VpcParams): TF.ResourceFieldMap {
  ...
  TF.addOptionalField(
    fields,
    'instance_tenancy',
    params.instance_tenancy,
    TF.stringValue
  );
  TF.addOptionalField(
    fields,
    'enable_dns_support',
    params.enable_dns_support,
    TF.booleanValue
  );
  TF.addOptionalField(
    fields,
    'enable_dns_hostnames',
    params.enable_dns_hostnames,
    TF.booleanValue
  );
  TF.addOptionalField(
    fields,
    'enable_classic_link',
    params.enable_classic_link,
    TF.booleanValue
  );
  TF.addOptionalField(fields, 'tags', params.tags, TF.tagsValue);
  return fields;
...
export function fieldsFromSubnetParams(
  params: SubnetParams
): TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
...
export function fieldsFromSecurityGroupParams(
  params: SecurityGroupParams
): TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
  TF.addOptionalField(fields, 'name', params.name, TF.stringValue);
  ...
  TF.addOptionalField(
    ...
    'ingress',
    params.ingress,
    TF.listValue(v => TF.mapValue(fieldsFromIngressRuleParams(v)))
  );
  TF.addOptionalField(
    fields,
    'egress',
    params.egress,
    TF.listValue(v => TF.mapValue(fieldsFromEgressRuleParams(v)))
  );
...
export function fieldsFromIngressRuleParams(
  params: IngressRuleParams
): TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
  ...
  TF.addField(
    ...
    'cidr_blocks',
    params.cidr_blocks,
    TF.listValue(TF.stringAliasValue)
  );
  return fields;
}
...
export function fieldsFromEgressRuleParams(
  params: EgressRuleParams
): TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
  TF.addField(fields, 'from_port', params.from_port, TF.numberValue);
  TF.addField(fields, 'to_port', params.to_port, TF.numberValue);
...
export function fieldsFromInternetGatewayParams(
  params: InternetGatewayParams
): TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
  TF.addField(fields, 'vpc_id', params.vpc_id, TF.resourceIdValue);
...
export function fieldsFromNatGatewayParams(
  params: NatGatewayParams
): TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
  TF.addField(
...
export function fieldsFromRouteTableParams(
  params: RouteTableParams
): TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
  TF.addField(fields, 'vpc_id', params.vpc_id, TF.resourceIdValue);
...
export function fieldsFromRouteParams(
  params: RouteParams
): TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
  TF.addField(
...
export function fieldsFromRouteTableAssociationParams(
  params: RouteTableAssociationParams
): TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
  TF.addField(fields, 'subnet_id', params.subnet_id, TF.resourceIdValue);
...
export function fieldsFromRoute53ZoneParams(
  params: Route53ZoneParams
): TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
...
export function fieldsFromRoute53RecordParams(
  params: Route53RecordParams
): TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
  ...
  TF.addOptionalField(
    ...
    'records',
    params.records,
    TF.listValue(TF.stringValue)
  );
  TF.addOptionalField(fields, 'alias', params.alias, v =>
    TF.mapValue(fieldsFromRoute53AliasParams(v))
  );
  return fields;
}
...
export function fieldsFromRoute53AliasParams(
  params: Route53AliasParams
): TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
  TF.addField(fields, 'name', params.name, TF.stringValue);
  TF.addField(fields, 'zone_id', params.zone_id, TF.stringAliasValue);
...
export function fieldsFromBucketVersioningParams(
  params: BucketVersioningParams
): TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
...
export function fieldsFromExpirationParams(
  ...
  TF.addOptionalField(
    ...
    params.expired_object_delete_marker,
    TF.booleanValue
  );
  return fields;
}
...
export function fieldsFromLifecycleRuleParams(
  params: LifecycleRuleParams
): TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
  ...
  TF.addOptionalField(fields, 'expiration', params.expiration, v =>
    TF.mapValue(fieldsFromExpirationParams(v))
  );
  return fields;
}
...
export function fieldsFromCorsRuleParams(
  params: CorsRuleParams
): TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
  TF.addOptionalField(
    fields,
...
export function fieldsFromS3BucketParams(
  params: S3BucketParams
): TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
  TF.addField(fields, 'bucket', params.bucket, TF.stringValue);
  TF.addOptionalField(fields, 'acl', params.acl, TF.stringAliasValue);
  TF.addOptionalField(fields, 'versioning', params.versioning, v =>
    TF.mapValue(fieldsFromBucketVersioningParams(v))
  );
  TF.addOptionalField(fields, 'lifecycle_rule', params.lifecycle_rule, v =>
    TF.mapValue(fieldsFromLifecycleRuleParams(v))
  );
  TF.addOptionalField(fields, 'cors_rule', params.cors_rule, v =>
    TF.mapValue(fieldsFromCorsRuleParams(v))
  );
  TF.addOptionalField(fields, 'tags', params.tags, TF.tagsValue);
  return fields;
}
...
export function fieldsFromS3BucketObjectParams(
  params: S3BucketObjectParams
): TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
  TF.addField(fields, 'bucket', params.bucket, TF.stringValue);
...
export function fieldsFromSnsTopicParams(
  params: SnsTopicParams
): TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
  TF.addField(fields, 'name', params.name, TF.stringValue);
...
export function fieldsFromIamUserParams(
  params: IamUserParams
): TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
  TF.addField(fields, 'name', params.name, TF.stringValue);
...
export function fieldsFromIamUserPolicyParams(
  params: IamUserPolicyParams
): TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
  TF.addField(fields, 'name', params.name, TF.stringValue);
...
export function fieldsFromIamUserPolicyAttachmentParams(
  params: IamUserPolicyAttachmentParams
): TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
  TF.addField(fields, 'user', params.user, TF.stringValue);
...
export function fieldsFromEcrRepositoryParams(
  params: EcrRepositoryParams
): TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
  TF.addField(fields, 'name', params.name, TF.stringValue);
...
export function fieldsFromDbSubnetGroupParams(
  params: DbSubnetGroupParams
): TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
  TF.addField(fields, 'name', params.name, TF.stringValue);
...
export function fieldsFromCloudwatchMetricAlarmParams(
  params: CloudwatchMetricAlarmParams
): TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
  ...
  TF.addOptionalField(
    fields,
    'actions_enabled',
    params.actions_enabled,
    TF.booleanValue
  );
  TF.addOptionalField(
    fields,
    'alarm_actions',
    params.alarm_actions,
    TF.listValue(TF.stringAliasValue)
  );
  TF.addOptionalField(
    fields,
    'alarm_description',
    params.alarm_description,
    TF.stringValue
  );
  ...
  TF.addOptionalField(
    ...
    params.insufficient_data_actions,
    TF.listValue(TF.stringAliasValue)
  );
  TF.addOptionalField(
    fields,
...
export function fieldsFromIamInstanceProfileParams(
  params: IamInstanceProfileParams
): TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
  TF.addOptionalField(fields, 'name', params.name, TF.stringValue);
...
export function fieldsFromIamRoleParams(
  params: IamRoleParams
): TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
  TF.addOptionalField(fields, 'name', params.name, TF.stringValue);
...
export function fieldsFromIamRolePolicyParams(
  params: IamRolePolicyParams
): TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
  TF.addField(fields, 'name', params.name, TF.stringValue);
...
export function fieldsFromSqsQueueParams(
  params: SqsQueueParams
): TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
  TF.addOptionalField(fields, 'name', params.name, TF.stringValue);
  ...
  TF.addOptionalField(
    ...
    params.visibility_timeout_seconds,
    TF.numberValue
  );
  TF.addOptionalField(
    fields,
    'message_retention_seconds ',
    params.message_retention_seconds,
    TF.numberValue
  );
  TF.addOptionalField(
    fields,
  ...
  TF.addOptionalField(
    ...
    params.receive_wait_time_seconds,
    TF.numberValue
  );
  ...
  TF.addOptionalField(
    ...
    params.content_based_deduplication,
    TF.booleanValue
  );
  TF.addOptionalField(fields, 'tags', params.tags, TF.tagsValue);
  return fields;
...
export function fieldsFromSqsQueuePolicyParams(
  params: SqsQueuePolicyParams
): TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
...
export function fieldsFromLbParams(params: LbParams): TF.ResourceFieldMap {
  ...
  TF.addOptionalField(fields, 'access_logs', params.access_logs, v =>
    TF.mapValue(fieldsFromLbAccessLogsParams(v))
  );
  TF.addOptionalField(
    fields,
    'subnets',
  ...
  TF.addOptionalField(
    fields,
    'subnet_mapping',
    params.subnet_mapping,
    TF.listValue(v => TF.mapValue(fieldsFromLbSubnetMappingParams(v)))
  );
  TF.addOptionalField(
    fields,
    'idle_timeout',
  ...
  TF.addOptionalField(
    ...
    params.enable_cross_zone_load_balancing,
    TF.booleanValue
  );
  TF.addOptionalField(
    fields,
...
export function fieldsFromLbAccessLogsParams(
  params: LbAccessLogsParams
): TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
  TF.addField(fields, 'bucket', params.bucket, TF.stringValue);
  TF.addOptionalField(
...
export function fieldsFromLbListenerParams(
  params: LbListenerParams
): TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
  TF.addField(
  ...
  TF.addField(fields, 'default_action', params.default_action, v =>
    TF.mapValue(fieldsFromLbListenerActionParams(v))
  );
  return fields;
}
...
export function fieldsFromLbListenerActionParams(
  params: LbListenerActionParams
): TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
  TF.addField(
    fields,
...
export function fieldsFromLbTargetGroupParams(
  params: LbTargetGroupParams
): TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
  TF.addOptionalField(fields, 'name', params.name, TF.stringValue);
  ...
  TF.addOptionalField(
    fields,
    'proxy_protocol_v2',
    params.proxy_protocol_v2,
    TF.booleanValue
  );
  TF.addOptionalField(fields, 'stickiness', params.stickiness, v =>
    TF.mapValue(fieldsFromLbTargetGroupStickinessParams(v))
  );
  TF.addOptionalField(fields, 'health_check', params.health_check, v =>
    TF.mapValue(fieldsFromLbTargetGroupHealthCheckParams(v))
  );
  TF.addOptionalField(
    fields,
    'target_type',
...
export function fieldsFromLbTargetGroupHealthCheckParams(
  params: LbTargetGroupHealthCheckParams
): TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
  TF.addOptionalField(fields, 'interval', params.interval, TF.numberValue);
  TF.addOptionalField(fields, 'path', params.path, TF.stringValue);
  ...
  TF.addOptionalField(
    fields,
    'healthy_threshold',
    params.healthy_threshold,
    TF.numberValue
  );
  TF.addOptionalField(
    fields,
    'unhealthy_threshold',
    params.unhealthy_threshold,
    TF.numberValue
  );
...
export function fieldsFromLbTargetGroupStickinessParams(
  params: LbTargetGroupStickinessParams
): TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
  TF.addField(fields, 'type', params.type, TF.stringValue);
  TF.addOptionalField(
...
export function fieldsFromLbTargetGroupAttachmentParams(
  params: LbTargetGroupAttachmentParams
): TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
  TF.addField(
...
export function fieldsFromLbListenerRuleParams(
  params: LbListenerRuleParams
): TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
  ...
  TF.addField(fields, 'action', params.action, v =>
    TF.mapValue(fieldsFromLbListenerActionParams(v))
  );
  TF.addField(fields, 'condition', params.condition, v =>
    TF.mapValue(fieldsFromLbListenerRuleConditionParams(v))
  );
  return fields;
}
...
export function fieldsFromLbListenerRuleConditionParams(
  params: LbListenerRuleConditionParams
): TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
...
export function fieldsFromCloudwatchLogGroupParams(
  params: CloudwatchLogGroupParams
): TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
  TF.addOptionalField(fields, 'name', params.name, TF.stringValue);
...
export function fieldsFromElasticsearchDomainParams(
  params: ElasticsearchDomainParams
): TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
  ...
  TF.addOptionalField(fields, 'ebs_options', params.ebs_options, v =>
    TF.mapValue(fieldsFromElasticsearchDomainEbsOptionsParams(v))
  );
  TF.addOptionalField(fields, 'cluster_config', params.cluster_config, v =>
    TF.mapValue(fieldsFromElasticsearchDomainClusterConfigParams(v))
  );
  TF.addOptionalField(fields, 'snapshot_options', params.snapshot_options, v =>
    TF.mapValue(fieldsFromElasticsearchDomainSnapshotOptionsParams(v))
  );
  TF.addOptionalField(
    fields,
    'elasticsearch_version',
    params.elasticsearch_version,
    TF.stringValue
  );
  TF.addOptionalField(fields, 'tags', params.tags, TF.tagsValue);
  return fields;
...
export function fieldsFromElasticsearchDomainClusterConfigParams(
  params: ElasticsearchDomainClusterConfigParams
): TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
  TF.addOptionalField(
    fields,
  ...
  TF.addOptionalField(
    ...
    params.dedicated_master_enabled,
    TF.booleanValue
  );
  TF.addOptionalField(
    fields,
    'dedicated_master_type',
    params.dedicated_master_type,
    TF.stringAliasValue
  );
  TF.addOptionalField(
    fields,
    'dedicated_master_count',
    params.dedicated_master_count,
    TF.numberValue
  );
  TF.addOptionalField(
    fields,
    'zone_awareness_enabled',
    params.zone_awareness_enabled,
    TF.booleanValue
  );
  return fields;
}
...
export function fieldsFromElasticsearchDomainEbsOptionsParams(
  params: ElasticsearchDomainEbsOptionsParams
): TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
...
export function fieldsFromElasticsearchDomainSnapshotOptionsParams(
  params: ElasticsearchDomainSnapshotOptionsParams
): TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
  TF.addField(
    fields,
    'automated_snapshot_start_hour',
    params.automated_snapshot_start_hour,
    TF.numberValue
  );
  return fields;
}
...
export function fieldsFromElasticsearchDomainPolicyParams(
  params: ElasticsearchDomainPolicyParams
): TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
  TF.addField(fields, 'domain_name', params.domain_name, TF.stringValue);
