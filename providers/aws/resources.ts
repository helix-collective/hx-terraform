...
export interface SecretsmanagerSecretParams {
  ...
  description?: string;
  tags?: TF.TagsMap;
  replica?: (SecretsmanagerSecretRepicaParams)[];
}
...
export function fieldsFromSecretsmanagerSecretParams(params: SecretsmanagerSecretParams) : TF.ResourceFieldMap {
  ...
  TF.addOptionalAttribute(fields, "description", params.description, TF.stringValue);
  TF.addOptionalAttribute(fields, "tags", params.tags, TF.tagsValue);
  TF.addRepeatedBlock(fields, "replica", params.replica, fieldsFromSecretsmanagerSecretRepicaParams);
  return fields;
}
...
export interface SecretsmanagerSecretRepicaParams {
  kms_key_id?: string;
  region: string;
}

export function fieldsFromSecretsmanagerSecretRepicaParams(params: SecretsmanagerSecretRepicaParams) : TF.ResourceFieldMap {
  const fields: TF.ResourceFieldMap = [];
