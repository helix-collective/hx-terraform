...
export class S3Ref {
    ...
    extendKey(extra: string): S3Ref {
      return new S3Ref(this.bucket, this.key + (extra.startsWith("/") ? "" : "/") + extra);
    }
  };
 ...
 */
export function createObjectFromJson(tfgen: TF.Generator, name: string, ref: S3Ref, json: {}): AR.S3BucketObject {
