...
export function texprCppCustomType(): ADL.ATypeExpr<CppCustomType> {
  return {value : {typeRef : {kind: "reference", value : {moduleName : "adlc.config.cpp",name : "CppCustomType"}}, parameters : []}};
}
...
export function texprInclude(): ADL.ATypeExpr<Include> {
  return {value : {typeRef : {kind: "reference", value : {moduleName : "adlc.config.cpp",name : "Include"}}, parameters : []}};
}
