...
export function texprSlaveState(): ADL.ATypeExpr<SlaveState> {
  return {value : {typeRef : {kind: "reference", value : {moduleName : "state",name : "SlaveState"}}, parameters : []}};
}
...
export function texprSlaveStatus(): ADL.ATypeExpr<SlaveStatus> {
  return {value : {typeRef : {kind: "reference", value : {moduleName : "state",name : "SlaveStatus"}}, parameters : []}};
}
