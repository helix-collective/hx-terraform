...
const autoscaling_group: RecordDecl = {
  ...
  fields: [
    ...
    optionalField('capacity_rebalance', BOOLEAN),
    ...
    optionalField('default_cooldown', NUMBER),
    ...
    optionalField('force_delete', BOOLEAN),
    ...
    optionalField('target_group_arns', listType(arnType(lb_target_group))),
    ...
    optionalField('placement_group', STRING),
    ...
    optionalField('min_elb_capacity', NUMBER),
    ...
    optionalField('max_instance_lifetime', NUMBER),
...
const secretsmanager_secret_repica: RecordDecl = {
  name: 'secretsmanager_secret_repica',
  fields: [
...
const secretsmanager_secret: RecordDecl = {
  ...
  fields: [
    ...
    optionalField('description', STRING),
    optionalField('tags', TAGS_MAP),
    optionalField('replica', repeatedBlockType(recordType(secretsmanager_secret_repica))),
  ],
};
...
function generateAws(gen: Generator) {
  ...
  gen.generateParams(secretsmanager_secret_repica);
